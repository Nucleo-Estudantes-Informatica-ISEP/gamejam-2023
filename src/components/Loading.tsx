...
const Loading: React.FC = () => {
  return (
    <section className="w-full flex flex-col items-center justify-center mb-32 relative">
      ...
      <motion.h1
        className="absolute bottom-0 translate-y-full text-white font-black text-5xl md:text-6xl lg:text-[9rem] text-center font-misterPixel uppercase drop-shadow-primaryStrokeShadow"
        initial={{
          scale: 0,
          opacity: 0
        }}
