...
const Loading: React.FC = () => {
  return (
    <section className="w-full flex flex-col items-center justify-center mb-32 relative">
      ...
      <motion.h1
        className="absolute bottom-0 md:-bottom-10 lg:-bottom-24 text-white font-black text-4xl md:text-5xl lg:text-[6rem] text-center font-misterPixel uppercase drop-shadow-primaryStrokeShadow"
        initial={{
          scale: 0,
          opacity: 0
        }}
